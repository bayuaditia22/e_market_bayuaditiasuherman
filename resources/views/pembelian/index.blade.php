                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <button type="button" class="btn btn-primary" id="tambahBarangBtn" data-toggle="modal" data-target="#tblBarangModal"><i class="fas fa-plus"></i>Tambah Barang</button>
...
<script>
    ...
    function tambahBarang(a) {
        ...
        data += '<input type="hidden" name="harga_beli[]" value="' + hargaBarang + '"> </td>'
